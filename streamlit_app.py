...
if selected_tab == "Perkenalan":
    ...
    st.write("Metode Storet merupakan cara untuk menentukan status mutu air dengan menggunakan sistem nilai dari “US-EPA (Environmental Protection Agency)” dengan mengklasifikasikan mutu air dalam empatkelas, yaitu :")
...
# Tab 1: Storet Calculation
    ...
    baku_mutu_options = ["BOD", "COD", "TSS", "Minyak Lemak", "Besi Terlarut", "Mangan Terlarut(Mn)", 
